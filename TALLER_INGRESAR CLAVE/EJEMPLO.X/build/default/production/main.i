...
void main(void) {
 INICIO:
    ...
    int clave3check = 0;
    int clave4check = 0;
    int clavechecktotal = 0;
    char clave1 = '3';
    char clave2 = '5';
    char clave3 = '8';
    char clave4 = '9';
    char direccion1 = 0b0011;
    char direccion2 = 0b0101;
    char direccion3 = 0b1000;
    char direccion4 = 0b1001;

    int DERE[4] = {0b1100, 0b0110, 0b0011, 0b1001};
    int IZQ[4] = {0b1001, 0b0011, 0b0110, 0b1100};

    if (eeprom_readx(direccion1) == 0xff) {
        eeprom_writex(direccion1, clave1);
    }
    if (eeprom_readx(direccion2) ==0xff ) {
        eeprom_writex(direccion2, clave2);
    }
    if (eeprom_readx(direccion3) == 0xff) {
    ...
    while (1) {
        ...
        if (tecla != 0) {
            ...
            if (tecla != 'A' && tecla != 'B' && tecla != 'C' && tecla != 'D' && tecla != '#' && tecla != '*') {
                ...
                LCD_gotoxy(2, 1);
                LCD_puts("INGRESAR CLAVE", 14);
                inclave[countinclave] = tecla;
                countinclave++;
                LCD_gotoxy(countinclave + 5, 2);
