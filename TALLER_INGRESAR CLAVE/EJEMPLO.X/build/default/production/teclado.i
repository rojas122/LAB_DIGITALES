...
for(i=0;i<4;i++){
   ...
   if(i==0){
      ...
      LATB = (1<<7)|(1<<6)|(1<<5)|(1<<4)|(1<<3)|(1<<2)|(1<<1)|(0<<0);
      _delay((unsigned long)((100)*(20000000UL/4000000.0)));
   ...
   if(i==1){
      LATB = (1<<7)|(1<<6)|(1<<5)|(1<<4)|(1<<3)|(1<<2)|(0<<1)|(1<<0);
      _delay((unsigned long)((100)*(20000000UL/4000000.0)));
   ...
   if(i==2){
      LATB = (1<<7)|(1<<6)|(1<<5)|(1<<4)|(1<<3)|(0<<2)|(1<<1)|(1<<0);
      _delay((unsigned long)((100)*(20000000UL/4000000.0)));
   ...
   if(i==3){
      LATB = (1<<7)|(1<<6)|(1<<5)|(1<<4)|(0<<3)|(1<<2)|(1<<1)|(1<<0);
      _delay((unsigned long)((100)*(20000000UL/4000000.0)));
